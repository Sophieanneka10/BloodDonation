...
import { Link as RouterLink, useNavigate, Routes, Route } from 'react-router-dom';
...
function Dashboard({ onLogout }) {
  ...
  const menuItems = [
    ...
    { text: 'Messages', icon: <Message />, path: '/dashboard/messages' },
    { text: 'Notifications', icon: <Notifications />, path: '/dashboard/notifications' },
    { text: 'Emergency', icon: <Warning />, path: '/dashboard/emergency' },
