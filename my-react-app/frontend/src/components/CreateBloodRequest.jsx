          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              ...
              <select
                ...
                required
                className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#f84444] focus:border-[#f84444] rounded-md"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#f84444] focus:border-[#f84444] sm:text-sm"
              />
            </div>
